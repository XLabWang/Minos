...
class XssHtml(HTMLParser):
    allow_tags = ['a', 'img', 'br', 'strong', 'b', 'code', 'pre', 'p', 'div',
                  'em', 'span', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6',
                  'blockquote', 'ul', 'ol', 'tr', 'th', 'td', 'hr', 'li', 'u',
                  's', 'table', 'thead', 'tbody', 'caption', 'small', 'q',
                  'sup', 'sub', 'font']
    ...
    def handle_starttag(self, tag, attrs):
        ...
        for (key, value) in attdict.items():
            attrs.append('%s="%s"' %
                         (key, self.__htmlspecialchars(value, True)))
